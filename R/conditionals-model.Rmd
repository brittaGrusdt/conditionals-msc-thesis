    ...
    for(bias in biases) {
      for(alpha in alphas){
        ...
        for(i in seq(1, n_runs)){
          ...
          target_model <-  paste("../data/seed-", SEEDS[i], "/model/", sep="")
          target_samples <-  paste("../data/seed-", SEEDS[i], "/samples/", sep="")
  
          checkAndCreateDir(target_model); checkAndCreateDir(target_samples)
