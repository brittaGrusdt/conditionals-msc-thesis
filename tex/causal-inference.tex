...
\usepackage{hyperref}
\usepackage{svg}
\graphicspath{{figs/debugspeaker/}}
\usepackage{listings}
...
\begin{figure}[h]
\centering
\subfloat[]{\label{fig:speakerBad-ac}\includesvg[]{figs/debugspeaker/Table4}} 
...
\begin{figure}[htp!]
\centering
\subfloat[]{\label{fig:speakerbad-ca}\includesvg[]{figs/debugspeaker/Table1}}
...
\begin{figure}
\centering
\subfloat[]{\label{fig:speakerGood-ca}\includesvg[]{figs/debugspeaker/Table2}} 
